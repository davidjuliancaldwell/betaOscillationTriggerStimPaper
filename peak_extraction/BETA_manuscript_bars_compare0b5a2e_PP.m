...
% This script only analyzes subject 0b5a2e (closed-loop) and its asynchronous
% playback control 0b5a2ePlayback — same patient, same 64-channel grid, same
% betaChan=31. valueSet entries for the other 6 subjects previously lived
% here as dead weight (copy-paste template) and have been removed.
SIDS = {'0b5a2e','0b5a2ePlayback'};
valueSet = {{'m',[90,270],7,[22 30],[24 25 29],[13 14 15 16 20 21 23 31 32 39 40],31,1.75},...
