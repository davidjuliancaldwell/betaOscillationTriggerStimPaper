...
addpath(genpath(locationsDir));
% external dependencies are now bundled in external_deps/ (copied from
% CircStat2012a, DBSanalysisCode) — no more external path reliance
